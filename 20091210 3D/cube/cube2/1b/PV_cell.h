...
//Indexed from original that definitely does self-oscillate
...
float I_tot_PV (int x, int y, int z)
{
   ...
   Ito=0.45*0.515*50.02*r1[x][y][z]*(0.8*pow(s1[x][y][z],3)+0.2*pow(s2[x][y][z],3))*(V[x][y][z]-Ek);     // CT - 0.2, PM - 0.35
